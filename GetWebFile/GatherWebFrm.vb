...
Public Class GatherWebFrm
    ...
    Private Sub startWork()
        ...
        ElseIf cbo_encoding.Text.Equals("gb2312") Then
            encoding = "gb2312"
        ElseIf cbo_encoding.Text.Equals("windows-1252") Then
            encoding = "windows-1252"
        ElseIf cbo_encoding.Text.Equals("iso-8859-1") Then
            encoding = "iso-8859-1"
        ElseIf cbo_encoding.Text.Equals("iso-8859-2") Then
            encoding = "iso-8859-2"
        ElseIf cbo_encoding.Text.Equals("iso-8859-3") Then
            encoding = "iso-8859-3"
        ElseIf cbo_encoding.Text.Equals("iso-8859-9") Then
        encoding = "iso-8859-9"
        End If
